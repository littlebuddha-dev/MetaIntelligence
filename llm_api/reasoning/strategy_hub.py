...
class Strategy:
    ...
    performance_metrics: Dict[str, float] = field(default_factory=lambda: {"success_rate": 0.0, "execution_count": 0})
    version: int = 1
...
class ThinkingStrategyHub:
    ...
    def update_strategy_performance(self, strategy_id: str, success: bool):
        ...
        total_runs = metrics['execution_count']
        current_success_rate = metrics['success_rate']
        
        # Calculate new success rate using a weighted average
